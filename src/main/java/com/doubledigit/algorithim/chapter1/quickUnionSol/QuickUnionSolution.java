...
public class QuickUnionSolution {
    ...
    public static void main(String[] args) {
        ...
        List<Student> studentList = Arrays.asList(new Student("Vivek", "Army"), new Student("Vikash", "KV"), new Student("Harsha", "Convent"),
                ...
                new Student("Nitesh", "Mah school"), new Student("Neeraj", "Rewa school"), new Student("Pari", "Mah school"),
                new Student("Mayank", "Rewa school"));

        Map<String, Student> studentMap = studentList.parallelStream()
        ...
        unionStudent(studentMap.get("Vivek"), studentMap.get("Vikash"));
        System.out.println("First Union Result..");
        printDatapoints(dataPoint);
        unionStudent(studentMap.get("Vikash"), studentMap.get("Neeraj"));
        System.out.println("Second Union Result..");
        printDatapoints(dataPoint);
        unionStudent(studentMap.get("Pari"), studentMap.get("Mayank"));
        System.out.println("Third Union Result..");
        printDatapoints(dataPoint);
        unionStudent(studentMap.get("Raj"), studentMap.get("Vivek"));
        System.out.println("Fourth Union Result..");
        printDatapoints(dataPoint);

        boolean connected = isConnected(studentMap.get("Vivek"), studentMap.get("Mayank"));
        System.out.println();
        System.out.println("Vivek and Mayank are connected ? - " + connected);
    }
